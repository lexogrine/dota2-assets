...
', origin: 'Crown', price: 450 },
  ...
  { name: 'item_arcane_boots', origin: 'Arcane Boots', price: 1400 },
  ...
  { name: 'item_blade_mail', origin: 'Blade Mail', price: 2300 },
  { name: 'item_bloodstone', origin: 'Bloodstone', price: 4350 },
  { name: 'item_bloodthorn', origin: 'Bloodthorn', price: 6625 },
  ...
  { name: 'item_guardian_greaves', origin: 'Guardian Greaves', price: 4300 },
  ...
  { name: 'item_heavens_halberd', origin: 'Heaven\'s Halberd', price: 2600 },
  ...
  { name: 'item_monkey_king_bar', origin: 'Monkey King Bar', price: 4700 },
  ...
  { name: 'item_shivas_guard', origin: 'Shiva\'s Guard', price: 5175 },
  ...
  { name: 'item_dimensional_doorway', origin: 'dimensional_doorway', price: 0 },
  ...
  { name: 'item_dagon_3', origin: 'Dagon', price: 5100 },
  { name: 'item_dagon_4', origin: 'Dagon', price: 6250 },
  { name: 'item_dagon_5', origin: 'Dagon', price: 7400 },
  ...
  { name: 'item_grandmasters_glaive', origin: 'grandmasters_glaive', price: 5000 },
  { name: 'item_gungir', origin: 'Gleipnir', price: 4550 },
  ...
  { name: 'item_lunar_crest', origin: 'Lunar Crest', price: 2275 },
  ...
  { name: 'item_eternal_shroud', origin: 'Eternal Shroud', price: 3700 },
  { name: 'item_mage_slayer', origin: 'Mage Slayer', price: 2800 },
  ...
  { name: 'item_specialists_array', origin: 'Specialist\'s Array', price: 2650 },
  ...
  { name: 'item_ancient_perseverance', origin: 'ancient_perseverance', price: 0 },
  { name: 'item_assassins_dagger', origin: 'assassins_dagger', price: 0 },
  { name: 'item_gladiator_helm', origin: 'gladiator_helm', price: 0 },
  { name: 'item_gloves_of_travel', origin: 'gloves_of_travel', price: 0 },
  { name: 'item_icarus_wings', origin: 'icarus_wings', price: 0 },
  { name: 'item_light_robes', origin: 'light_robes', price: 0 },
  { name: 'item_mechanical_arm', origin: 'mechanical_arm', price: 0 },
  { name: 'item_oakheart', origin: 'oakheart', price: 0 },
  { name: 'item_overflowing_elixir', origin: 'overflowing_elixir', price: 0 },
  { name: 'item_satchel', origin: 'satchel', price: 0 },
  { name: 'item_star_mace', origin: 'star_mace', price: 0 },
  { name: 'item_venom_gland', origin: 'venom_gland', price: 0 },
  { name: 'item_warhammer', origin: 'warhammer', price: 0 },
  { name: 'item_wizard_glass', origin: 'wizard_glass', price: 0 },
  ...
  { name: 'item_recipe_blade_mail', origin: 'Blade Mail Recipe', price: 750 },
  ...
  { name: 'item_recipe_glimmer_cape', origin: 'Glimmer Cape Recipe', price: 450 },
  { name: 'item_recipe_guardian_greaves', origin: 'Guardian Greaves Recipe', price: 1125 },
  ...
  { name: 'item_recipe_monkey_king_bar', origin: 'Monkey King Bar Recipe', price: 600 },
  { name: 'item_recipe_orchid', origin: 'Orchid Malevolence Recipe', price: 450 },
  { name: 'item_recipe_pipe', origin: 'Pipe of Insight Recipe', price: 800 },
  ...
  { name: 'item_recipe_veil_of_discord', origin: 'Veil of Discord Recipe', price: 320 },
  ...
  { name: 'item_recipe_arcane_boots', origin: 'Arcane Boots Recipe', price: 475 },
  { name: 'item_recipe_arcane_ring', origin: 'override', price: 0 },
  { name: 'item_recipe_ballista', origin: 'override', price: 0 },
  { name: 'item_recipe_bfury', origin: 'Battle Fury Recipe', price: 600 },
  ...
  { name: 'item_recipe_gungir', origin: 'Gleipnir Recipe', price: 1100 },
  ...
  { name: 'item_recipe_lunar_crest', origin: 'recipe_lunar_crest', price: 250 },
  ...
  { name: 'item_recipe_shivas_guard', origin: 'Shiva\'s Guard Recipe', price: 2050 },
  ...
  { name: 'item_recipe_witch_blade', origin: 'Witch Blade Recipe', price: 250 },
  ...
  { name: 'item_recipe_samurai_tabi', origin: 'recipe_samurai_tabi', price: 1100 },
  { name: 'item_samurai_tabi', origin: 'samurai_tabi', price: 5250 },
  { name: 'item_recipe_hermes_sandals', origin: 'recipe_hermes_sandals', price: 500 },
  { name: 'item_hermes_sandals', origin: 'hermes_sandals', price: 4800 },
  { name: 'item_recipe_witches_switch', origin: 'recipe_witches_switch', price: 625 },
  { name: 'item_witches_switch', origin: 'witches_switch', price: 1900 },
  { name: 'item_dagon', origin: 'Dagon', price: 2800 },
  ...
  { name: 'item_fortitude_ring', origin: 'fortitude_ring', price: 0 },
  ...
  { name: 'item_aetherial_halo', origin: 'aetherial_halo', price: 5900 },
  ...
  { name: 'item_sample_picker', origin: 'sample_picker', price: 0 },
  ...
  { name: 'item_horizons_equilibrium', origin: 'horizons_equilibrium', price: 0 },
  { name: 'item_blighted_spirit', origin: 'blighted_spirit', price: 0 },
  { name: 'item_dandelion_amulet', origin: 'Dandelion Amulet', price: 0 },
  { name: 'item_turtle_shell', origin: 'turtle_shell', price: 0 },
  ...
  { name: 'item_black_grimoire', origin: 'Black Grimoire', price: 0 },
  ...
  { name: 'item_cursed_circlet', origin: 'Accursed', price: 0 },
  { name: 'item_ogre_heart', origin: 'Restorative', price: 0 },
  { name: 'item_neutral_tabi', origin: 'Elusive', price: 0 },
  { name: 'item_enhancement_audacious', origin: 'Audacious', price: 0 },
  { name: 'item_hellbear_totem', origin: 'hellbear_totem', price: 0 },
  ...
  { name: 'item_crystal_raindrop', origin: 'Crystal Raindrop', price: 0 },
  ...
  { name: 'item_circlet_of_the_flayed_twins', origin: 'Circlet of the Flayed Twins', price: 0 },
  ...
  { name: 'item_recipe_specialists_array', origin: 'recipe_specialists_array', price: 650 },
